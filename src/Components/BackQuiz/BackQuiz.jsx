...
import { databack } from "../../Assets/databack";
...
function BackQuiz() {
  ...
  const [question, setQuestion] = useState(databack[index]);
  ...
  return (
    <div className="container">
      ...
      {result ? (
        <>
          <h2 className="result">
            You Scored {score} out of {databack.length}{" "}
          </h2>
